...
public class AirParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AirGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAirportAccess().getCodeAssignment_1(), "rule__Airport__CodeAssignment_1");
			builder.put(grammarAccess.getAirportAccess().getNameAssignment_2(), "rule__Airport__NameAssignment_2");
			...
			builder.put(grammarAccess.getAirplaneAccess().getAirplaneIdAssignment_1(), "rule__Airplane__AirplaneIdAssignment_1");
			builder.put(grammarAccess.getAirplaneAccess().getAirplaneTypeAssignment_2(), "rule__Airplane__AirplaneTypeAssignment_2");
			builder.put(grammarAccess.getAirplaneAccess().getSeatsAssignment_3(), "rule__Airplane__SeatsAssignment_3");
			builder.put(grammarAccess.getFlightAccess().getFlightIdAssignment_1(), "rule__Flight__FlightIdAssignment_1");
			...
			builder.put(grammarAccess.getPilotAccess().getEmpIdAssignment_1(), "rule__Pilot__EmpIdAssignment_1");
			builder.put(grammarAccess.getPilotAccess().getNameAssignment_2(), "rule__Pilot__NameAssignment_2");
			builder.put(grammarAccess.getPilotAccess().getAirlineAssignment_4(), "rule__Pilot__AirlineAssignment_4");
			builder.put(grammarAccess.getFlightAttendantAccess().getEmpIdAssignment_1(), "rule__FlightAttendant__EmpIdAssignment_1");
			builder.put(grammarAccess.getFlightAttendantAccess().getNameAssignment_2(), "rule__FlightAttendant__NameAssignment_2");
			builder.put(grammarAccess.getFlightAttendantAccess().getAirlineAssignment_4(), "rule__FlightAttendant__AirlineAssignment_4");
			builder.put(grammarAccess.getBagHandlerAccess().getEmpIdAssignment_1(), "rule__BagHandler__EmpIdAssignment_1");
			builder.put(grammarAccess.getBagHandlerAccess().getNameAssignment_2(), "rule__BagHandler__NameAssignment_2");
			builder.put(grammarAccess.getBagHandlerAccess().getAirportAssignment_4(), "rule__BagHandler__AirportAssignment_4");
			builder.put(grammarAccess.getGatePersonnelAccess().getEmpIdAssignment_1(), "rule__GatePersonnel__EmpIdAssignment_1");
			builder.put(grammarAccess.getGatePersonnelAccess().getNameAssignment_2(), "rule__GatePersonnel__NameAssignment_2");
			builder.put(grammarAccess.getGatePersonnelAccess().getAirportAssignment_4(), "rule__GatePersonnel__AirportAssignment_4");
			builder.put(grammarAccess.getPassengerAccess().getEmailAssignment_1(), "rule__Passenger__EmailAssignment_1");
			builder.put(grammarAccess.getPassengerAccess().getNameAssignment_2(), "rule__Passenger__NameAssignment_2");
