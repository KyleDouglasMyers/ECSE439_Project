...
public class AirParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AirGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFlightAccess().getGroup_14(), "rule__Flight__Group_14__0");
			...
			builder.put(grammarAccess.getFlightAccess().getFromAssignment_3(), "rule__Flight__FromAssignment_3");
			builder.put(grammarAccess.getFlightAccess().getToAssignment_5(), "rule__Flight__ToAssignment_5");
			builder.put(grammarAccess.getFlightAccess().getAirlineAssignment_7(), "rule__Flight__AirlineAssignment_7");
			builder.put(grammarAccess.getFlightAccess().getTimeAssignment_9(), "rule__Flight__TimeAssignment_9");
			builder.put(grammarAccess.getFlightAccess().getPilotAssignment_11(), "rule__Flight__PilotAssignment_11");
			builder.put(grammarAccess.getFlightAccess().getStaffAssignment_13(), "rule__Flight__StaffAssignment_13");
			builder.put(grammarAccess.getFlightAccess().getStaffAssignment_14_1(), "rule__Flight__StaffAssignment_14_1");
			...
			builder.put(grammarAccess.getPilotAccess().getAirelineAssignment_3(), "rule__Pilot__AirelineAssignment_3");
			builder.put(grammarAccess.getFlightAttendantAccess().getNameAssignment_1(), "rule__FlightAttendant__NameAssignment_1");
			builder.put(grammarAccess.getFlightAttendantAccess().getAirelineAssignment_3(), "rule__FlightAttendant__AirelineAssignment_3");
			builder.put(grammarAccess.getBagHandlerAccess().getNameAssignment_1(), "rule__BagHandler__NameAssignment_1");
			builder.put(grammarAccess.getBagHandlerAccess().getAirportAssignment_3(), "rule__BagHandler__AirportAssignment_3");
			builder.put(grammarAccess.getGatePersonnelAccess().getNameAssignment_1(), "rule__GatePersonnel__NameAssignment_1");
			builder.put(grammarAccess.getGatePersonnelAccess().getAirportAssignment_3(), "rule__GatePersonnel__AirportAssignment_3");
		}
	}
